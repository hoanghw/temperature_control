...
public class Utils {
    ...
    static final String CURRENT_HUMIDITY = "current_condition";  // current outside condition
    static final String INSIDE_TEMPERATURE = "T_kplus1";
    static final String INSIDE_HUMIDITY = "HP.0013a20040a8c307.h";
    static final String HEATER = "switch";
    static final String MPC = "MPC_control";
    static final String URL_GET_HEATER = "http://api.xively.com/v2/feeds/730000241/datastreams/switch";
    static final String URL_GET_MPC = "http://api.xively.com/v2/feeds/730000241/datastreams/MPC_control";
    static final String URL_CURRENT_T = "http://api.xively.com/v2/feeds/730000241/datastreams/current_tc";
    static final String URL_CURRENT_H = "http://api.xively.com/v2/feeds/730000241/datastreams/current_condition";
    static final String URL_INSIDE_T = "http://api.xively.com/v2/feeds/730000241/datastreams/T_kplus1";
    ...
    static final String URL_SET_MPC = "https://api.xively.com/v2/feeds/730000241.json";
    ...
    static final int CHANNEL_MPC = 6;
